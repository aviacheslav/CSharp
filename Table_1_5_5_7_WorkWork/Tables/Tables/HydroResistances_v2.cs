...
namespace Tables
{
    ...
    public class HydroPipelineElement : ICloneable
    {
       ...
       int Conn_Suc0Par1;
        ...
        //    SetNull();
        //}
        public HydroPipelineElement(double k = 0, int Succ0Parallel1 = 0, HydroPipelineElement[] elems = null, HydroPipelineElement upper = null, int QElements = 0, int CurN = 0, int NInUpper = 0, TValsShowHide vsh = null)
        {
        ...
        public void Set(double k = 0, int Succ0Parallel1 = 0, HydroPipelineElement[] elems = null, HydroPipelineElement upper = null, int QElements = 0, int CurN = 0, int NInUpper = 0)
        {
            SetNull();
        ...
        //
        public void Set_k(double N) { this.k = k; }
        public double Get_k() { return this.k; }
        //
        //
        ...
        public void AddInner(HydroPipelineElement elem, TValsShowHide vsh=null)
        {
            ...
            HydroPipelineElement NewElem = new HydroPipelineElement();
            if (elem != null)
            {
        ...
        //
        public void  AddSucSmart(HydroPipelineElement ElementExt, int smartAdd=0, double k_new=0, TValsShowHide vsh=null){
            ...
            if(this.upper==null || ( this.upper!=null && this.upper.Conn_Suc0Par1==1)){
                ...
                ElementInstead=new HydroPipelineElement(this.k, this.Conn_Suc0Par1,this.elems, this,  this.QElements, newN,  this.NinUpper, vsh);
        ...
        public object Clone()
        {
            HydroPipelineElement data = new HydroPipelineElement();
            ...
            else if (this.upper != null)
            {
                ...
                if (this.upper.Conn_Suc0Par1 == 1)
                {
                    ...
                    for (int i = 2; i <= this.NinUpper - 1; i++)
                    {
                        ...
                        yLowerCur = this.upper.elems[i - 1].vis_yLower(vsh);
                        y = y + yUpperCur + 1 + yLowerCur + 1;
                        MyLib.writeln(vsh, i.ToString() + ")  y=y+yUpperCur[i]+1(ipse)+yLower[i]+1(space lower)= " + y.ToString() + " (yUpperCur[i]=" + yUpperCur.ToString() + " yLowerCur[i]" + yUpperCur.ToString() + ")");
                    }
                    //
                    if (this.NinUpper > 1)
                    {
