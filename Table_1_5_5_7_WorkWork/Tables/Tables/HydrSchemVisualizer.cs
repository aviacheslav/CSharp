...
namespace Tables
{
    public partial class HydrSchemVisualizer : Form_TableCalling//Form
    {
        ...
        private void button_Edit_Click(object sender, EventArgs e)
        {
            ...
            DataTopic.DataN = 1;// this.PTR.GetN();//Mab exnot: PTR. Or ne exnot, if PTR wa alt'd af table wa cal'd
        ...
        //
        public override void SetDataFromCurrentTable(TableDataChange dataId)
        {
            if (dataId.DataN == 1)
            {
                this.PTR.hydroResistance_IniDataAdvanced_SetFromTable(this.CurrentTable);
            }
            if (dataId.DataN == 2)
            {
                this.PTR.hydroResistance_MainResData_SetFromTable(this.CurrentTable);
            }
        }

        private void button_PipeLineData_Click(object sender, EventArgs e)
        {
            TableDataChange DataTopic = new TableDataChange();
            DataTopic.DataTypeIni1Fin2Medium3Cfg4 = 1; //ini data 
            DataTopic.DataTopicN = 1; //ini data of R, its ini geom
            DataTopic.DataN = 2;// this.PTR.GetN();//Mab exnot: PTR. Or ne exnot, if PTR wa alt'd af table wa cal'd

            //TTable tbl = this.PTR.hydroResistance_IniData_GetAsTable();
            TTable tbl = this.PTR.hydroResistance_MainResData_GetAsTable();
        ...
        {
            //textBox2.Text = "L " + this.dataGridView1.CurrentCell.RowIndex.ToString() + " C" + this.dataGridView1.CurrentCell.ColumnIndex.ToString();
        } 
