...
namespace Tables
{
    ...
    public class PrimitiveElement : ICloneable
    {
        ...
        {
            int y=0, yMyUpper, yUpper, yLower1, yUpperCur, yLowerCur;
            ...
            {
                yUpper = this.upper.vis_y(vsh);
                if (this.upper.Conn_Suc0Par1 == 1)
                {
                    if (this.outerN >= 1)
                    {
                        y = yUpper;
                        MyLib.writeln(vsh, "Ce part of " + this.upper.ToString() + " [" + this.outerN.ToString() + "]>=1 => y=y(upper)=" + yUpper.ToString() + "=" + y.ToString());
                    }
                    if (this.outerN >= 2)
                    {
                        yLower1 = this.upper.elems[1 - 1].vis_yLower(vsh);
                        y = y + yLower1 + 1;
                        MyLib.writeln(vsh, "Ce part of " + this.upper.ToString() + " [" + this.outerN.ToString() + "]>=2 y=y(upper)+yLower[1]+1= " + y.ToString() + " (y(upper)=" + yUpper.ToString() + " yLower[1]=" + yLower1.ToString() + ")");
                    }
                    if (this.outerN > 2)
                    {
                        for (int i = 2; i <= this.outerN - 1; i++)
                        {
                ...
                {
                    y = yUpper;
                    MyLib.writeln(vsh, "united [--]. y=y(upper)=" + yUpper.ToString() + "=" + y.ToString());
                }
            }
        ...
        public void vis_DisplayAll(HydroSchemCanvas canvas, TValsShowHide vsh=null)
        {
            ...
            if (this.upper == null && this.upper.Conn_Suc0Par1 == 1 && this.NinUpper > 1)
            {
                ...
                y1 = this.upper.elems[NinUpper - 1 - 1].vis_y(vsh);
                ...
                for(int i=1; i<=Q; i++){
                    rows[i-1]=new DataCellRow(new DataCell[]
                                    {       new DataCell(succ[i-1].data.GroupN), // new DataCell("GroupN"), 
                                            ...
                                            new DataCell(succ[i-1].data.D), // new DataCell("D"), 
                                            new DataCell(succ[i-1].data.D1), //new DataCell("D1"),
