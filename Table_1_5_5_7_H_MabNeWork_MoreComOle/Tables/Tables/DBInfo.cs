...
namespace Tables
{
    ...
    public class TDBTableHeaderData : ICloneable
    {
        ...
        //
        public TDBTableHeaderData(string[] arr, int QItems = 0, int FromN = 1)
        {//ne verf'd
            if(arr!=null && (QItems<1||QItems>arr.Length)){
                 QItems =arr.Length;
            }
            this.SetFromStringArray(arr, QItems, FromN);
        }
        //
        public object Clone()
        {
    ...
    public class TDBFieldCreationDataWithItemsTable : ICloneable
    {
        ...
        {//ne verf'd
            if(arr!=null && (L<1 || L>arr.Length)){
                L=arr.Length;
            }
            SetFromStringArray(arr, L, FromN);
        }
        //
        public object Clone()
        {
