...
namespace Tables
{
    public partial class ExcelConnecting1 : Form
    {
        ...
        public Form_TableCalling f1;
        public TExcelTableFitInfo data;
        ...
        public ExcelConnecting1()
        {
            ...
            //this.excel =f1.excel;
            this.excel = null; //link wi aim'd af constr, dum work
            data = new TExcelTableFitInfo();
            //
            //
        ...
        private void ReadTableDataFromForm()
        {
            TableData.CoLHExportDBData = this.checkBox_CoLH_ExportDBData.Checked;
            TableData.CoLHDBType = this.checkBox_CoLH_DBType.Checked;
            TableData.LoCHExportDBData = this.checkBox_LoCH_ExportDBData.Checked;
            TableData.LoCHDBType = this.checkBox_LoCH_DBType.Checked;
            TableData.HdrCrnrExportDBData = this.checkBox_CrnrHdrs_ExportDBData.Checked;
            TableData.HdrCrnrDBType = this.checkBox_CrnrHdrs_DBType.Checked;
            TableData.TblHdrExportDBData = this.checkBox_TblHdr_ExportDBData.Checked;
            TableData.TblHdrDBType = this.checkBox_TblHdr_DBType.Checked;
            TableData.ColGenHdrExportDBData = this.checkBox_CGH_ExportDBData.Checked;
            TableData.ColGenHdrDBType = this.checkBox_CGH_DBType.Checked;
            TableData.LinGenHdrExportDBData = this.checkBox_LGH_ExportDBData.Checked;
            TableData.LinGenHdrDBType = this.checkBox_LGH_DBType.Checked;
            TableData.CurCellExportDBData = this.checkBox_CurCell_ExportDBData.Checked;
            //
            TableData.LoCH_EachColDataHorisontal = this.checkBox_LoCH_EachColData_Hor.Checked;
            TableData.CoLH_EachLineDataVertical = this.checkBox_CoLH_EachLineData_Vert.Checked;
            TableData.ImportToVerticalRows = this.checkBox_RowsVertical.Checked;
            //
            TableData.ContentSheet = this.comboBox_Content_Sheet.Text;
            TableData.CoLHSheet = this.comboBox_CoLH_Sheet.Text;
            TableData.LoCHSheet = this.comboBox_LoCH_Sheet.Text;
            TableData.HdrCrnrSheet = this.comboBox_HdrCrnr_Sheet.Text;
            TableData.TblHdrSheet = this.comboBox_TableHeader_Sheet.Text;
            TableData.ColGenHdrSheet = this.comboBox_ColsGenHdr_Sheet.Text;
            TableData.LinGenHdrSheet = this.comboBox_LinesGenHeader_Sheet.Text;
            //TableData.CurCellSheet = this.comboBox_CurCell_Sheet.Text;
        }
        private void button_Import_Click(object sender, EventArgs e)
        {
            ...
            string CurCellFirst, CurCellLast, CurCellActiveVal;
            ...
            //       TblHdrFirst, TblHdrLast, ColGenHdrFirst, ColGenHdrLast, LinGenHdrFirst, LinGenHdrLast;
            //int ContentFirst_LineN, ContentFirst_ColN, ContentLast_LineN, ContentLast_ColN,
            //    LoCHFirst_LineN, LoCHFirst_ColN, LoCHLast_LineN, LoCHLast_ColN,
            //    CoLHFirst_LineN, CoLHFirst_ColN, CoLHLast_LineN, CoLHLast_ColN,
            //    HeaderCorner_LineN, HeaderCorner_ColN,
            //    CurCellFirst_LineN, CurCellFirst_ColN, CurCellLast_LineN, CurCellLast_ColN, CurCellActiveVal_LineN, CurCellActiveVal_ColN,
            //    TblHdrFirst_LineN, TblHdrFirst_ColN, TblHdrLast_LineN, TblHdrLast_ColN,
            //    ColGenHdrFirst_LineN, ColGenHdrFirst_ColN, ColGenHdrLast_LineN, ColGenHdrLast_ColN,
            //    LinGenHdrFirst_LineN, LinGenHdrFirst_ColN, LinGenHdrLast_LineN, LinGenHdrLast_ColN;
            string val;
            ...
            if (this.radioButton_CurCell.Checked)
            {
                ...
                TableData = new TExcelTableFitInfo();
                //
                this.excel.ParseCellName(this.textBox_content_erst.Text, ref TableData.FirstContentColumnN, ref TableData.FirstContentLineN);
                this.excel.ParseCellName(this.textBox_content_last.Text, ref TableData.LastContentColumnN, ref TableData.LastContentLineN);
                this.excel.ParseCellName(this.textBox_LoCH_erst.Text, ref TableData.FirstLoCHColumnN, ref TableData.FirstLoCHLineN);
                this.excel.ParseCellName(this.textBox_LoCH_last.Text, ref TableData.LastLoCHColumnN, ref TableData.LastLoCHLineN);
                this.excel.ParseCellName(this.textBox_CoLH_erst.Text, ref TableData.FirstCoLHColumnN, ref TableData.FirstCoLHLineN);
                this.excel.ParseCellName(this.textBox_CoLH_last.Text, ref TableData.LastCoLHColumnN, ref TableData.LastCoLHLineN);
                this.excel.ParseCellName(this.textBox_ColGenHdr_1.Text, ref TableData.FirstColGenHdrColumnN, ref TableData.FirstColGenHdrLineN);
                this.excel.ParseCellName(this.textBox_ColGenHdr_2.Text, ref TableData.LastColGenHdrColumnN, ref TableData.LastColGenHdrLineN);
                this.excel.ParseCellName(this.textBox_LinGenHdr_1.Text, ref TableData.FirstLinGenHdrColumnN, ref TableData.FirstLinGenHdrLineN);
                this.excel.ParseCellName(this.textBox_LinGenHdr_2.Text, ref TableData.LastLinGenHdrColumnN, ref TableData.LastLinGenHdrLineN);
                this.excel.ParseCellName(this.textBox_TblHdr_1.Text, ref TableData.FirstTblHdrColumnN, ref TableData.FirstTblHdrLineN);
                this.excel.ParseCellName(this.textBox_TblHdr_2.Text, ref TableData.LastTblHdrColumnN, ref TableData.LastTblHdrLineN);
                //
                this.ReadTableDataFromForm();
                //
