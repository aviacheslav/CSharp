...
namespace Tables
{
    ...
    public class TableHeaders:ICloneable
    {
        ...
        public TableHeaders(string TableName, string LinesGeneralName, string ColumnsGeneralName)
        {
            this.Set(TableName, LinesGeneralName, ColumnsGeneralName);
        }
        public TableHeaders(DataCell TableHeader, DataCell LinesGeneralHeader, DataCell ColumnsGeneralHeader)
        {
            SetNull();
            this.TableHeader = TableHeader;
            this.LinesGeneralHeader = LinesGeneralHeader;
            this.ColumnsGeneralHeader = ColumnsGeneralHeader;
        }
        ...
        public void Set(string TableName, string LinesGeneralName, string ColumnsGeneralName, bool StrNullMeansCellNotToChange_NotMakeCellNull=false)
        {
            ...
            {
                if (StrNullMeansCellNotToChange_NotMakeCellNull)
                {
                    this.TableHeader = null;
                }//else NOp
            }
            if (LinesGeneralName != null && LinesGeneralName != "")
            {
                this.LinesGeneralHeader = new DataCell(LinesGeneralName);
            }
            else
            ...
            if (ColumnsGeneralName != null && ColumnsGeneralName != "")
            {
                this.ColumnsGeneralHeader = new DataCell(ColumnsGeneralName);
            }
            else
